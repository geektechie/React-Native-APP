        ...
        return (
            <View style={styles.container}>
                  <TextInput
                        ...
                        <ScrollView>
                    <Text style={{ color: '#0091ff',fontSize: 18,fontWeight: 'bold',marginLeft: 13 }}>Hyype Five</Text>                                                                               
                    ...
                    <TouchableOpacity onPress={() => Alert.alert('hello.') }>            
                         <Text style={{ color: '#f6f6f6', fontSize: 16, textAlign: 'center',marginTop: 20 }}> Show All </Text> 
                    </TouchableOpacity>  
                    <Text></Text>
                    </ScrollView>
            </View>
