            ...
            <View style={styles.container}>
                  <TextInput
                    ...
                    <Text style={{ color: '#0091ff',fontSize: 15,fontWeight: 'bold',marginLeft: 13, marginBottom: 10 }}>HYYPE Five</Text>                                                                               
                     <TouchableOpacity style={styles.button} onPress={() => navigate('BarDetails') }>            
                    ...
                    <View style= {{width: 320,height: 1,marginTop: 10,backgroundColor:"#f6f6f6", marginBottom: 5}} /> 
                    ...
                    <TouchableOpacity onPress={() => Alert.alert('hello.') }>            
                         <Text style={{ color: '#ababab', fontSize: 12, textAlign: 'center',marginTop:15 }}> SHOW ALL </Text> 
                    </TouchableOpacity>  
                    <Text></Text>
                    </ScrollView>
            </View>
